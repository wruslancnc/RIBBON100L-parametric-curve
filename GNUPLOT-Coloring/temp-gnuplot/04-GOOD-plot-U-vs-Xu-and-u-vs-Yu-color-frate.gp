...
set title "Teardrop curve - u versus (x[u] color-valueof[x], y[u] color-valueof[y])" 

set xlabel "parameter(u)"
set xrange [ 0.00000 : +1.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback

set ylabel "curr-frate(u), x-frate(u), y-frate(u)"
...
## ==================================================================
## File: 04-plot-u-vs-Xu-and-u-vs-Yu-color-frate.gp

set title "Teardrop curve - u versus (x[u] color = val x[u], y[u] color= val y[u])" 

set xlabel "parameter[u]"
set xrange [ 0.00000 : 1.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback

set ylabel "pos-x[u] color = val x, and pos-y[u] color= val y"
set yrange [ -40.00000 : +40.0000 ] noreverse nowriteback
set y2range [ * : * ] noreverse writeback
...
## WITH NO COLOR (linecolor palette)
...
# u-versus-pos-y[u] ==> col-valueof[y]

plot   'coloring.dat' using 2:(($8)):8 with lines linewidth 3 linecolor palette
replot 'coloring.dat' using 2:(($9)):9 with lines linewidth 3 linecolor palette

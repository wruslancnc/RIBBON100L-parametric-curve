...
\begin{table}[ht]
	\begin{center}
		\begin{tabular}[top]{ p{16.0 cm} }
			\frame{\includegraphics[width=0.95\textwidth]{./07-images/img-Ch53/FC20-Snailshell-x-y-curr-feedrates.png}}\\
		\end{tabular}
...
\begin{table}[ht]
	\begin{center}
		\begin{tabular}[top]{ p{16.0 cm} }
			...
			\frame{\includegraphics[width=0.95\textwidth]{./07-images/img-Ch53/FC20-Snailshell-x-y-curr-colored-feedrates.png}}\\

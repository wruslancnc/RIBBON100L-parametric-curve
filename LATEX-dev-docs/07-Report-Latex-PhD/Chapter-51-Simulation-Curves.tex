...
\begin{figure}[htbp]
	\begin{center}
		\frame{\includegraphics[width=0.95\textwidth]{./07-images/img-Ch52/Ellipse-and-Skewed-Astroid-run-data-summary.png}}\\
		\frame{\includegraphics[width=0.42\textwidth]{./07-images/img-Ch5/ELLIPSE-Feedrate.png}}
		\frame{\includegraphics[width=0.42\textwidth]{./07-images/img-Ch5/SKEWED-ASTROID-Feedrate.png}}\\

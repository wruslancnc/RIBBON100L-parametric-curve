...
\input{Chapter-5-Simulation-Results}

\include{./Chap-5-tex/Teardrop}
\include{./Chap-5-tex/Butterfly}
\include{./Chap-5-tex/Ellipse}
\include{./Chap-5-tex/Skewed-Astroid}
\include{./Chap-5-tex/Circle}
\include{./Chap-5-tex/AstEpi}
\include{./Chap-5-tex/Snailshell}
\include{./Chap-5-tex/SnaHyp}
\include{./Chap-5-tex/Ribbon-10L}
\include{./Chap-5-tex/Ribbon-100L}

%% File: main-12-Report-Latex-PhD.tex
...
\input{Chapter-4-Software-Interpolator-Design}

\input{Chapter-5-Simulation-Experiment}

\input{Chapter-51-Selected-Parametric-Curves}

\include{./Chap-51-tex/Teardrop}
\include{./Chap-51-tex/Butterfly}
\include{./Chap-51-tex/Ellipse}
\include{./Chap-51-tex/Skewed-Astroid}
\include{./Chap-51-tex/Circle}
\include{./Chap-51-tex/AstEpi}
\include{./Chap-51-tex/Snailshell}
\include{./Chap-51-tex/SnaHyp}
\include{./Chap-51-tex/Ribbon-10L}
\include{./Chap-51-tex/Ribbon-100L}

\input{Chapter-52-Total-Interpolated-Points}

\include{./Chap-51-tex/Teardrop-profile-interpolated-points}
\include{./Chap-51-tex/Butterfly-profile-interpolated-points}
\include{./Chap-51-tex/Ellipse-profile-interpolated-points}
\include{./Chap-51-tex/Skewed-Astroid-profile-interpolated-points}
\include{./Chap-51-tex/Circle-profile-interpolated-points}
\include{./Chap-51-tex/AstEpi-profile-interpolated-points}
\include{./Chap-51-tex/Snailshell-profile-interpolated-points}
\include{./Chap-51-tex/SnaHyp-profile-interpolated-points}
\include{./Chap-51-tex/Ribbon-10L-profile-interpolated-points}
\include{./Chap-51-tex/Ribbon-100L-profile-interpolated-points}


\input{Chapter-52-Simulation-Run-Results}

\include{./Chap-52-tex/Teardrop-Butterfly-run-result}
\include{./Chap-52-tex/Ellipse-Skewed-Astroid-run-result}
\include{./Chap-52-tex/Circle-AstEpi-run-result}
\include{./Chap-52-tex/Snailshell-SnaHyp-run-result}
\include{./Chap-52-tex/Ribbon-10L-Ribbon-100L-run-result}


\input{Chapter-53-Feedrate-Profiles}

\include{./Chap-53-tex/Teardrop-feedrate}
\include{./Chap-53-tex/Butterfly-feedrate}
\include{./Chap-53-tex/Ellipse-feedrate}
\include{./Chap-53-tex/Skewed-Astroid-feedrate}
\include{./Chap-53-tex/Circle-feedrate}
\include{./Chap-53-tex/AstEpi-feedrate}
\include{./Chap-53-tex/Snailshell-feedrate}
\include{./Chap-53-tex/SnaHyp-feedrate}
\include{./Chap-53-tex/Ribbon-10L-feedrate}
\include{./Chap-53-tex/Ribbon-100L-feedrate}

\input{Chapter-54-Error-per-unit-length-traversed}

\include{./Chap-54-tex/FC10-Error-per-unit-length-traversed}
\include{./Chap-54-tex/FC20-Error-per-unit-length-traversed}
\include{./Chap-54-tex/FC25-Error-per-unit-length-traversed}
\include{./Chap-54-tex/FC30-Error-per-unit-length-traversed}
\include{./Chap-54-tex/FC40-Error-per-unit-length-traversed}

\input{Chapter-54-Histogram-of-Interpolated-Points}

\include{./Chap-54-tex/Teardrop-interpolated-points}
\include{./Chap-54-tex/Butterfly-interpolated-points}
\include{./Chap-54-tex/Ellipse-interpolated-points}
\include{./Chap-54-tex/Skewed-Astroid-interpolated-points}
\include{./Chap-54-tex/Circle-interpolated-points}
\include{./Chap-54-tex/AstEpi-interpolated-points}
\include{./Chap-54-tex/Snailshell-interpolated-points}
\include{./Chap-54-tex/SnaHyp-interpolated-points}
\include{./Chap-54-tex/Ribbon-10L-interpolated-points}
\include{./Chap-54-tex/Ribbon-100L-interpolated-points}

\input{Chapter-55-Experimental-Validation}



\input{Chapter-6-Analyses-and-Discussion}
